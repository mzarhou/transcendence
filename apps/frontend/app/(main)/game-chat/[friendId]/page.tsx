...
function MessageItem({ message: msg }: MessageItemProps) {
  ...
  return (
    <div
      ref={messageRef}
      className={cn(
        "w-2/3 break-words  rounded-md bg-chat-card px-4 pb-3 pt-4 text-chat-card-foreground",
